...
{
public:
    Client(int _id, QString _lastName, QString _firstName, QString _adress, QString _city, int _postalCode, QDate _appointmentDate, int _appointmentDuration, int _priority, QString _commentary, int _phoneNumber);
